...
public class CobblemcoreBlock extends MhcoreModElements.ModElement {
	@ObjectHolder("mhcore:cobblemcore")
	public static final Block block = null;
	public CobblemcoreBlock(MhcoreModElements instance) {
		super(instance, 2);
	}
