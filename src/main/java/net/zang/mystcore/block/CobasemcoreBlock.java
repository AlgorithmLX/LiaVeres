...
public class CobasemcoreBlock extends MhcoreModElements.ModElement {
	@ObjectHolder("mhcore:cobasemcore")
	public static final Block block = null;
	public CobasemcoreBlock(MhcoreModElements instance) {
		super(instance, 4);
	}
